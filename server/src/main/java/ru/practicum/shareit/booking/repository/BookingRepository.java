...
public interface BookingRepository extends JpaRepository<Booking, Long> {
    ...
    Optional<Booking> findTop1ByItemIdAndStartDateBeforeAndStatusOrderByStartDateDesc(
            Long itemId, LocalDateTime now, BookingStatus status);

    Optional<Booking> findTop1ByItemIdAndStartDateAfterAndStatusOrderByStartDateAsc(
            Long itemId, LocalDateTime now, BookingStatus status);

    boolean existsByBookerIdAndItemIdAndStatusAndEndDateBefore(
